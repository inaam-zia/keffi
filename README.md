...
A simple web app for Teakuzz. Customers scan a QR code at their table and order from their phone. Staff manage everything from a browser — **nothing to install on the restaurant computer**.
...
3. Add environment variables from `.env.example`:
   ...
   - `NEXT_PUBLIC_CAFE_NAME` (e.g. "Teakuzz")
